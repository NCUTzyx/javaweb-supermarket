...
import com.zyx.service.bill.BillService;
import com.zyx.service.bill.BillServiceImpl;
...
public class BillServlet extends HttpServlet {
    ...
    //获取订单列表
    public void getProviderlist(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
    ...
    //删除订单
    public void delBill(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        String id = request.getParameter("billid");
